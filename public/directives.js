...
app.directive('myElem',
    function () {
        return {
            ...
            template: '<div><div id="{{chartId}}" style="min-width: 310px; height: 500px; margin: 0 auto"></div><div id="info"></div><div id="info-content"></div></div>',
                        ...
                        listeners: [
                            {
                                ...
                                method: function (event) {
                                    document.getElementById("info").innerHTML =
                                        "<p><b>" +
                                        event.mapObject.title + " -- " + event.mapObject.info.date + ':' + event.mapObject.info.time +
                                        "</b></p><p>" +
                                        'Round :' + event.mapObject.info.round + '<br/>' +
                                        'Race Url : <a href="' + event.mapObject.info.raceUrl + '" target="_blank">' + event.mapObject.info.raceUrl + '</a><br/>' +
                                        'Circuit Url : <a href="' + event.mapObject.info.circuitUrl + '" target="_blank">' + event.mapObject.info.circuitUrl + '</a>' +
                                        "</p><p>"
                                    // $( "#info-content" ).html( '<pre>'+event.mapObject.info.info+'</pre>' );    
                                }
                            }
                        ]
            ...
            link: function (scope) {
                ...
                scope.$watch('raceResults', function () {
                    ...
                    if (scope.raceResults && scope.raceResults.laps) {
                        // console.log("here if",scope.raceResults);
